...
- Verify the permanent phone serial. Never configure a changing wireless endpoint as the identity. Keep pairing codes in a private local interactive prompt, outside arguments, transcripts, logs, and Git.
